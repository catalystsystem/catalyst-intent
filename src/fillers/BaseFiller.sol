...
abstract contract BaseFiller is IPayloadCreator, BaseOracle {
     ...
     * Is expected to call _fill(bytes32,OutputDescription,uint256,bytes32)
    ...
    function _fill(
        ...
        bytes32 dataHash =
            keccak256(OutputEncodingLib.encodeFillDescription(proposedSolver, orderId, uint32(block.timestamp), output));
