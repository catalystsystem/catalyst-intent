...
contract TestPermitDutchOrder is TestPermit {
    ...
    function test_cross_order_hash(
        ...
        bytes32 expectedHashedDutchOrderData = keccak256(
            abi.encode(
                ...
                dutchOrderData.remoteOracle,
                dutchOrderData.slopeStartingTime,
                dutchOrderData.inputSlope,
                dutchOrderData.outputSlope,
                expectedHashedInput,
                expectedHashedOutput
            )
        );
        ...
        ISignatureTransfer(permit2).permitWitnessTransferFrom(
            ...
            SWAPPER,
            actualHashedCrossOrderType,
            CrossChainDutchOrderType.permit2WitnessType(),
            sig
        );
