...
contract InputSettler7683LIFIHarness is InputSettler7683LIFI {
    constructor(address initialOwner) InputSettler7683LIFI(initialOwner) {}
...
contract InputSettler7683TestBaseLIFI is InputSettler7683Test {
    ...
    function test_validate_fills_now(
        ...
        InputSettler7683LIFIHarness(inputsettler7683).validateFills(
            address(this),
            orderId,
            MandateOutputs
        );
    ...
    function test_invalid_governance_fee() public {
        vm.prank(owner);
        InputSettler7683LIFIHarness(inputsettler7683).setGovernanceFee(
            MAX_GOVERNANCE_FEE
        );
    ...
    function test_governance_fee_change_not_ready(
        ...
        assertEq(
            InputSettler7683LIFIHarness(inputsettler7683).governanceFee(),
            0
        );
    ...
    function test_finalise_self_with_fee(uint64 fee) public {
        ...
        bytes32 orderId = InputSettler7683LIFIHarness(inputsettler7683)
            .orderIdentifier(compactOrder);
        ...
        vm.expectCall(
            ...
            abi.encodeWithSignature(
                ...
                abi.encodePacked(
                    ...
                    mandate.outputs[0].oracle,
                    mandate.outputs[0].settler,
                    payloadHash
                )
            )
        );
        ...
        assertEq(
            token.balanceOf(
                InputSettler7683LIFIHarness(inputsettler7683).owner()
            ),
            govFeeAmount
        );
    }
