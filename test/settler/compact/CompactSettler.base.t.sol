...
contract CompactSettlerWithDepositHarness is CompactSettlerWithDeposit {
    constructor(address compact, address initialOwner) CompactSettlerWithDeposit(compact, initialOwner) { }
...
contract CompactSettlerTestBase is Test {
    CompactSettlerWithDepositHarness compactSettler;
    ...
    function setUp() public virtual {
        ...
        compactSettler = new CompactSettlerWithDepositHarness(address(theCompact), address(0));
