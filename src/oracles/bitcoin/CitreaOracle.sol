...
contract CitreaOracle is BitcoinOracle {
    constructor(address _citrea, address autoDisputedCollateralTo, address collateralToken) payable BitcoinOracle(_citrea, autoDisputedCollateralTo, collateralToken) { }
