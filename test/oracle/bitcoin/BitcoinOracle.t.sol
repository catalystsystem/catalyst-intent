...
contract TestBitcoinOracle is Test {
    ...
    function test_claim(
        bytes32 solver, bytes32 orderId, uint64 amount, address caller
    ) external {
    ...
    function test_dispute(
        bytes32 solver, bytes32 orderId, uint64 amount, address caller, address disputer
    ) external {
    ...
    function test_verify(
         bytes32 solver, bytes32 orderId, address caller
    ) external {
        vm.assume(solver != bytes32(0));
        vm.assume(orderId != bytes32(0));
        vm.assume(caller != address(0));
    ...
    function test_revert_script_mismatch_verify_embed(
         bytes32 solver, bytes32 orderId, address caller, bytes calldata remoteCall
    ) external {
    ...
    function test_revert_bad_amount(
         bytes32 solver, bytes32 orderId, address caller, uint64 diffAmount
    ) public {
    ...
    function test_revert_bad_token(
         bytes32 solver, bytes32 orderId, address caller, bytes32 badTokenIdentifier
    ) public {
    ...
    function test_revert_wrong_utxo_type(
         bytes32 solver, bytes32 orderId, address caller, bytes1 wrongUTXOType
    ) public {
    ...
    function test_revert_no_block(
         bytes32 solver, bytes32 orderId, address caller, uint256 blockHeight
    ) public {
    ...
    function test_revert_not_enough_confirmations(
         bytes32 solver, bytes32 orderId, address caller, bytes1 confirmations
    ) public {
