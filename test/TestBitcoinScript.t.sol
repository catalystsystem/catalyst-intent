...
import { AddressType as ScriptAddressType, BitcoinAddress } from "../src/interfaces/Structs.sol";
import { BtcScript } from "../src/libs/BtcScript.sol";
import "../src/libs/BitcoinOpcodes.sol";
